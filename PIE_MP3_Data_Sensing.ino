...
void loop() {
  ...
  // determine speeds and directions
  int finalLeftSpeed = leftSpeed * speedMultiplier * lSign;
    
  int finalRightSpeed = rightSpeed * speedMultiplier * rSign;
  
  // print time, motor speeds, and sensor values to Serial
  Serial.print(millis());
  Serial.print(", ");
  Serial.print(finalLeftSpeed);
  Serial.print(", ");
  Serial.print(finalRightSpeed);
  Serial.print(", ");
